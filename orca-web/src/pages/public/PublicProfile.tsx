    ...
    <section className="mx-auto w-full max-w-2xl space-y-5">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Manage your public ORCA experience and preferences.
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm leading-6 text-slate-500">
              Account information will appear here when authentication is
              connected.
            </p>
          </div>
        </div>
      ...
      <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
        ...
        <ProfileRow
          ...
          title="Privacy"
          description="Review your account and location permissions."
        />
      ...
      <section className="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-slate-500">
              Public users see marine information intended for public access.
              Internal operational decisions and private commitments are not
              exposed here.
            </p>
          </div>
        </div>
