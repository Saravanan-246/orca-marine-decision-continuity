    ...
    <section className="mx-auto w-full max-w-2xl space-y-5">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Manage the operator account and operational preferences.
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm leading-6 text-slate-500">
              Account details will appear here when authentication and operator
      ...
      <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
        <ProfileRow
          ...
          title="Operator role"
          description="Maritime operations workspace"
        />

        <ProfileRow
          icon={<Settings2 size={17} />}
          title="Operational preferences"
          description="Alerts, display and workspace preferences"
        />
